...
public class Assets extends AssetManager {
    ...
    public Animation<TextureRegion> space, alien, aliendie, naveidle, naveleft, naveright, naveshoot, shoot ,alienshoot, powerup,shipdie;
    ...
    void loadAnimations(){
        ...
        powerup = new Animation<TextureRegion>(0.1f,atlas.findRegions("powerup"));
        shipdie = new Animation<TextureRegion>(0.1f, atlas.findRegions("shipdie"));
